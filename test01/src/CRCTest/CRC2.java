...
//2.查表法：
    ...
    public static void main(String args[]) {
        ...
        byte[] b3  =Test01.gbk2str(tx, len);
        int a3 = getCRC1021(b3, b3.length);//18321
        System.out.println("查表法:" + a3);
        String str3= Integer.toHexString(a3).toUpperCase();//18321
        System.out.println("十六进制:" + str3);//4791
        System.out.println("计算法:" + CRC_XModem(b3));
        System.out.println("十六进制:"
                + Integer.toHexString(CRC_XModem(b3)).toUpperCase());
    }
